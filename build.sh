...
$LINK msgpack.bc msgpack_codegen.bc | $OPT -internalize -internalize-public-api-list="foronly_string_example,foronly_unsigned_example,nop_handle_msgpack_example,skip_next_message_example,message_is_string_example" -O3 -o merged.bc
